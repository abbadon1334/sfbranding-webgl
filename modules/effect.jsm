//Code by Inigo Quilez 2009 <http://www.iquilezles.org/apps/shadertoy/>
//Patch for loading textures from chrome URIs By Tom Peeters <tom@thefrontdoor.nl>

var EXPORTED_SYMBOLS = ["Effect"];
...
function Effect(util, gl,xres,yres)
{
    this.util = util;
    this.mGLContext = gl;
    this.mQuadVBO = null;
...
Effect.prototype.NewTexture = function(slot,txt)
{
    ...
    var tmpTexture = (txt=="")?null:this.util.loadImageTexture(gl, txt);
